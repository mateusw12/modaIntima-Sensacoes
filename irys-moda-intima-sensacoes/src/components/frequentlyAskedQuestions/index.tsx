    ...
    <div className={styles.frequentlyContainer}>
      ...
      <Accordion className={styles.accordion}>
        ...
        <AccordionDetails className={styles.accordionDetails}>
          <p>
            Nós funcionamos das 08h às 17h, de segunda à sexta, só para retirar
            pacotinhos prontos, ok?
          </p>
          <p>
      ...
      <Accordion className={styles.accordion}>
        ...
        <AccordionDetails className={styles.accordionDetails}>
          <p>
            ...
            através dos Correios. Pode esperar seu pacote cheio de amor em casa,
            pronto para arrancar sorrisos! 🥰
          </p>
        </AccordionDetails>
      </Accordion>
